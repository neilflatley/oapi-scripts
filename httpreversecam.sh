...
ffmpeg -hide_banner -allowed_media_types video -fflags nobuffer -flags low_delay -user_agent oapi/ffmpeg -rtsp_transport tcp -i rtsp://192.168.12.1:8554/rear -an -r 10 -vf "hflip,scale=512:-1" -g 50 -bf 0 -pix_fmt yuv420p -f v4l2 /dev/video0
